...
class SemanticSeg(object):
    ...
    def __init__(self,net_name=None,encoder_name=None,lr=1e-3,n_epoch=1,channels=1,num_classes=2,roi_number=1,scale=None, input_shape=None,crop=48,
                  ...
                  weight_decay=0.,momentum=0.95,gamma=0.1,milestones=[40,80],T_max=5,mean=None,std=None,topk=50,use_fp16=True):
    ...
    def trainer(self,train_path,val_path,cur_fold,output_dir=None,log_dir=None,optimizer='Adam',
        ...
        # loss_threshold = 1.0
        early_stopping = EarlyStopping(patience=40,verbose=True,monitor='val_run_dice',op_type='max')
